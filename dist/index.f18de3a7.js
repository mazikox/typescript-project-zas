...
})({"8DjtJ":[function(require,module,exports,__globalThis) {
...
var _testDataJs = require("./data/test-data.js");
var _testDataJsDefault = parcelHelpers.interopDefault(_testDataJs);
...
const questions = shuffleArray((0, _testDataJsDefault.default).questions);
let testTimer;
let elapsedTime = 0;
let questionTimer;
...
function findIndexWithMaxTime(questionTimes) {
    if (questionTimes.length === 0) return -1;
    let maxTime = questionTimes[0];
    let maxIndex = 0;
    for(let i = 1; i < questionTimes.length; i++)if (questionTimes[i] > maxTime) {
...
nextButton.addEventListener("click", ()=>{
    if (currentQuestionIndex < questions.length - 1) switchQuestion(currentQuestionIndex + 1);
});
endButton.addEventListener("click", ()=>{
    ...
    statsElement.innerHTML = `
        ...
        <p>\u{141}\u{105}czny czas: ${elapsedTime} sekund</p>
        <p>Poprawne odpowiedzi: ${correctAnswers} z ${totalQuestions}</p>
        <p>\u{15A}redni czas na pytanie: ${averageTime.toFixed(2)} sekund</p>
        <p>Najwi\u{119}cej sp\u{119}dzonego czasu na pytaniu nr ${findIndexWithMaxTime(questionTimes) + 1} </p>
    `;
});
...
},{"./data/test-data.js":"gL05M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gL05M":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const data = {
    title: "Test wiedzy og\xf3lnej",
    questions: [
        {
            "question": "S\u0142o\u0144 to:",
            "correctAnswer": "Ssak",
        ...
        {
            "question": "Panda wielka \u017Cywi si\u0119 g\u0142\xf3wnie:",
            "correctAnswer": "Bambusem",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Ry\u017Cem",
        ...
        {
            "question": "P\u0142etwal b\u0142\u0119kitny nale\u017Cy do:",
            "correctAnswer": "Ssak\xf3w",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Ryby",
        ...
        {
            "question": "Koala \u017Cyje na:",
            "correctAnswer": "Drzewach",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Drzewach",
        ...
        {
            "question": "Stru\u015B jest najwi\u0119kszym:",
            "correctAnswer": "Ptakiem",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Ssakiem",
        ...
        {
            "question": "Kt\xf3re zwierz\u0119 jest najszybszym l\u0105dowym ssakiem?",
        ...
        {
            "question": "Wielb\u0142\u0105d przystosowany jest do \u017Cycia w:",
            "correctAnswer": "Pustyniach",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Pustyniach",
        ...
        {
            "question": "\u017B\xf3\u0142w morski \u017Cyje g\u0142\xf3wnie:",
            "correctAnswer": "W wodzie",
            "timeSpend": 0,
            "answers": [
                {
                    "content": "Na l\u0105dzie",
...
},{}]},["8DjtJ","7SwCM"], "7SwCM", "parcelRequire94c2")
